...
// Async Thunk to fetch new orders count
export const fetchNewOrdersCount = createAsyncThunk("orders/fetchNewOrdersCount", async (_, { rejectWithValue }) => {
    try {
...
// Async Thunk to fetch orders DETAILS id
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchUserOrders.fulfilled, (state, action) => {
                state.loading = false;
                state.orders = action.payload.orders || action.payload; // ✅ handle both array & object
            ...
            .addCase(fetchNewOrdersCount.fulfilled, (state, action) => {
                state.newOrdersCount = action.payload.count;
            })
    }
