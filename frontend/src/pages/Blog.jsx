...
function BlogPage() {
  return (
    <main>
      <SEO
        title="Blog | 3D Printing Insights & Tutorials"
        description="Stay updated with the latest trends in 3D printing, material guides, and manufacturing news from Anuveshana Technologies."
        keywords="3D printing blog, material guides, rapid prototyping tutorials, manufacturing news, additive manufacturing"
        type="website"
      />
