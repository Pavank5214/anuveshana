...
const OrderDetailsPage = () => {
  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto p-4 sm:p-6 mt-30 animate-pulse">
        {/* Page Title Skeleton */}
        <div className="h-8 w-1/3 bg-gray-300 rounded mb-6"></div>
  
        {/* Order Details Card Skeleton */}
        <div className="p-4 sm:p-6 bg-white rounded-xl shadow-lg border space-y-6">
          {/* Order Info */}
          ...
          {/* Payment & Shipping Skeleton */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-10">
            {Array(3)
              .fill(0)
              .map((_, idx) => (
                <div key={idx} className="bg-gray-50 p-4 rounded-lg shadow-sm space-y-2">
          ...
          <div className="overflow-x-auto mb-8">
            ...
            {Array(3)
              .fill(0)
              .map((_, idx) => (
                <div key={idx} className="flex justify-between items-center bg-gray-100 p-4 rounded mb-2">
