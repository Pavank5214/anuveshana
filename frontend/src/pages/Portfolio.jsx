...
const Portfolio = () => {
  ...
  return (
    <main className="mt-5 min-h-screen bg-[#0B0F19] text-white pt-28 pb-20 relative overflow-x-hidden selection:bg-orange-500/30">
      <SEO
        title="Our Portfolio | Precision 3D Printed Masterpieces"
        description="Explore our curated selection of high-precision components engineered for automotive, medical, and industrial sectors. See the quality of our 3D printing work."
        keywords="3D printing portfolio, automotive prototypes, medical 3D printing, industrial components, manufacturing showcase"
        type="website"
      />
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {filterButtons.map((btn) => (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 border ${activeFilter === btn.filter
