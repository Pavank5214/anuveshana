...
const Topbar = ({ isNavOpen }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-[60] transition-all duration-500 ease-in-out h-10
      ${visible ? "translate-y-0" : "-translate-y-full"} 
      ${isNavOpen ? "blur-md brightness-50 pointer-events-none" : "blur-0 brightness-100"}`}
    >
      {/* Background & Borders */}
