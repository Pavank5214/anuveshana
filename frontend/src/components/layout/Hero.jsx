    ...
    <section className="relative w-full h-screen overflow-hidden bg-[#0B0F19]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 max-w-7xl mx-auto -translate-y-[15%]">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-7xl md:text-8xl font-black leading-[1.1] tracking-tighter mb-6 text-white">
          ...
          <p className="text-sm md:text-2xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed font-light">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/upload"
                className="group flex items-center gap-2 bg-[#ff6200] hover:bg-[#e55a00] text-white px-8 py-3 sm:px-10 sm:py-4 rounded-full text-base sm:text-lg font-bold shadow-lg shadow-orange-500/25 transition-all duration-300"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/collections/all"
                className="inline-block bg-transparent border-2 border-white text-white px-6 py-2.5 sm:px-8 sm:py-3 rounded-full text-base sm:text-lg font-semibold shadow-lg hover:bg-white hover:text-black transition-all duration-300"
              >
                Shop Now
              </Link>
            </motion.div>
