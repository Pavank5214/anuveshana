...
import featured from "../../assets/hero.jpg"
    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-100 rounded-3xl">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                Apperel made for everyday life
            </h2>
            <p className="text-lg text-gray-600 mb-6">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam a tempore id deserunt temporibus? Rem molestiae eum repellendus dolores reprehenderit facilis neque quam eius, molestias commodi accusantium harum eligendi eos.
            </p>
