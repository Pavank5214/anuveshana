    ...
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <p className='font-medium text-sm text-gray-600 mb-6'>
                Sign up and get 10% off on your fiest order.
            </p>
            {/* Newsletter form*/}
            <form className='flex'>
                <input type="email"placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required></input>
            ...
            <div>
                ...
                <div className='flex items-center space-x-4 mb-6'>
                    ...
                    <a href='https://facebook.com' target="_blank" rel="noopener noreferrer" className='hover:text-gray-500'><TbBrandX className='h-4 w-5'/></a>
                    <a href='https://facebook.com' target="_blank" rel="noopener noreferrer" className='hover:text-gray-500'><TbBrandInstagram className='h-5 w-5'/></a>
                </div>
                <p className="text-gray-500">Call Us</p>
                <p><FiPhoneCall className='inline-block mr-2'/>+91 9380400291</p>
            </div>
    </div>
    {/* Footer Bottom */}
    <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
        <p className='text-gray-500 text-sm trackingtighter text-center'>@2025, CompileTab. AllRights Reserved. </p>
    </div>
   </footer>
  )
}
