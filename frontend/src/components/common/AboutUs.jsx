...
const AboutPage = () => {
  ...
  return (
    <main className="bg-[#0B0F19] text-white min-h-screen relative overflow-x-hidden selection:bg-orange-500/30">
      <SEO
        title="About Us | Advanced Manufacturing & 3D Printing"
        description="Learn about Anuveshana Technologies. Our mission is to democratize advanced manufacturing through precision engineering and industrial-grade 3D printing technologies."
        keywords="about us, 3D printing company, manufacturing mission, FDM technology, SLA precision, SLS engineering"
        type="website"
      />
