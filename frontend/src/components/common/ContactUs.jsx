...
function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen pt-28 pb-20 overflow-hidden bg-[#0B0F19] text-white selection:bg-orange-500/30 mt-5">
      <SEO
        title="Contact Us | Start Your 3D Printing Project"
        description="Get in touch with Anuveshana Technologies for your 3D printing and manufacturing needs. Reach out for quotes, support, or project inquiries."
        keywords="contact us, 3D printing quote, manufacturing support, Bangalore 3D printing, project inquiry"
        type="website"
      />
