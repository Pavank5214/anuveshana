...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-500 md:flex-row relative">
        ...
        {isSidebarOpen && (
            <div className="fixed inset-0 z-10 bg-gray-500 bg-opacity-50 md:hidden" onClick={toggleSidebar}></div>
        )}
        {/* sidebar */}
