      ...
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0} className="mb-8">
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-white tracking-tight uppercase">Add New Project</h1>
              <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mt-0.5">Create a new work item</p>
            </div>
          </div>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Form Section */}
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={1} className="lg:col-span-8 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 flex items-center gap-2">
                    <Type size={12} className="text-blue-500" /> Project Title
                  </label>
                  <input
                    type="text"
                    name="name"
                    ...
                    className="w-full bg-[#0B0F19] border border-white/10 rounded-2xl px-6 py-4 text-sm font-bold text-white outline-none focus:border-blue-500/50 transition-all placeholder:text-slate-800"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="5"
                    className="w-full bg-[#0B0F19] border border-white/10 rounded-2xl px-6 py-4 text-sm font-bold text-white outline-none focus:border-blue-500/50 transition-all placeholder:text-slate-800 resize-none"
                    required
                  />
                </div>
              </div>
            ...
            <div className="bg-[#121620] border border-white/[0.06] rounded-[2.5rem] p-6 sm:p-10 space-y-8 shadow-2xl">
              <div className="flex items-center justify-between">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 flex items-center gap-2">
                  <ImageIcon size={12} className="text-blue-500" /> Project Photos
                </label>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <AnimatePresence>
                  {portfolioData.images.map((img, idx) => (
                    ...
                    >
                      <img src={img} className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-all" alt="" />
                      <button
                        type="button"
                ...
                <label className="relative aspect-[4/3] rounded-2xl border-2 border-dashed border-white/10 hover:border-blue-500/30 flex flex-col items-center justify-center cursor-pointer group transition-all bg-white/[0.01] hover:bg-blue-500/5">
                  ...
                  {uploading ? (
                    ...
                    <>
                      ...
                      <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Add Photo</span>
                    </>
                  )}
                </label>
              </div>
            ...
            <div className="bg-[#121620] border border-white/[0.06] rounded-[2.5rem] p-8 space-y-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <button
                  ...
                  className="w-full py-5 rounded-2xl bg-white/5 border border-white/10 text-slate-400 text-[11px] font-black uppercase tracking-[0.2em] hover:bg-white/10 hover:text-white transition-all shadow-xl"
                >
                  Cancel
                </button>
              </div>
              ...
              <div className="pt-6 border-t border-white/[0.04]">
                <div className="flex items-center gap-3 text-slate-700">
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-widest leading-relaxed">This will save the project to your list</p>
                </div>
              </div>
            </div>
          </motion.div>
