...
router.post("/", protect, admin, async (req, res) => {
    try {
        ...
        const product = new Product({
            ...
            personalizationFields: Array.isArray(personalizationFields) ? personalizationFields : [],
...
router.put("/:id", protect, admin, async (req, res) => {
    try {
        ...
        if (product) {
            ...
            product.personalizationFields = personalizationFields || product.personalizationFields;
...
router.get("/", async (req, res) => {
    try {
        const { collection, size, textColor, baseColor, minPrice, maxPrice, sortBy, search, category } = req.query;
